...
<body>		
	...
	<div class="container">
		<div class ="text-center" style="font-size:36px;background:#1a38ca;width:1150px;height:100px">用户信息管理系统
		</div>
			<div class="row">
				...
				<h2 style="text-align:center;margin-top:-400px">编辑用户信息</h2>
				</hr>
				<form class="form-horizontal" action="UserServlet?type=modify" method="post">
					<div class="form-group">
						...
						<lable for="inputUserName" class="col-sm-2 control-lable">姓名:</lable>
							<div class="col-sm-10">
								<input type="text" value="${modifyUser.username }" class="form-control" name="username" id="username" >
							</div>
					</div>
					<div class="form-group">
						<lable for="inputPassword" class="col-sm-2 control-lable">密码：</lable>
							<div class="col-sm-10">
								<input type="text" value="${modifyUser.password }" class="form-control" name="password" id="password" >
							</div>
					</div>
					<div class="form-group">
						<lable for="inputGrade" class="col-sm-2 control-lable">等级：</lable>
							<div class="col-sm-10">
								<input type="text" value="${modifyUser.grade }" class="form-control" name="grade" id="grade" >
							</div>
					</div>
					<div class="form-group">
						<lable for="inputEmail" class="col-sm-2 control-lable">邮箱：</lable>
							<div class="col-sm-10">
								<input type="text" value="${modifyUser.email }" class="form-control" name="email" id="email" >
							</div>
					</div>
					<div class="form-group">
